...
public interface MemberMapper {
    ...
    // 멤버 수정
    void update(@Param("id") Long id, @Param("dto") MemberUpdateDto dto);

    void UpdatePassword(@Param("email") String email, @Param("newPassword") String newPassword);

    void UpdateEmail(@Param("email") String email, @Param("dto") MemberUpdateDto dto);
    ...
    void payment(@Param("email") String email,@Param("dto") MemberUpdateDto dto);
