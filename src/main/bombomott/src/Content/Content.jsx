...
import ContentTrailer from "../TrailerApi";
import TvTrailer from "../TvTrailerApi";
...
function Content(props) {
  ...
  if (mediaType === "movie") {
    ContentTrailer(receivedData.id);
  } else if (mediaType === "tv") {
    TvTrailer(receivedData.id);
  }
  ...
  return contentDetail && Object.keys(contentDetail).length != 0 ? (
    <div className="contentPage-container">
      ...
      <ContentDetail
        ...
        receivedDataAll={receivedDataAll}
      />
      <Footer />
      <ToTop />
    </div>
