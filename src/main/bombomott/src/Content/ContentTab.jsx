...
function TabContent(props){
    ...
    const {recommendList} = RecommendationsApi(contentType, contentId)

    return [contentType == 'movie' ? <ContentSlide data={recommendList} SlideItemNum={SlideItemNum}/> :<ContentEpisode SlideItemNum={SlideItemNum}/>, 
            contentType == 'movie' ? <ContentTabText data={props.receivedData} genre={props.genre}/> : <ContentSlide data={recommendList} SlideItemNum={SlideItemNum}/>, 
