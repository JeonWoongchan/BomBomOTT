    ...
    return(
            ...
            
            {
                ...
                DataArray.map((a,i)=>{
                    ...
                    const TYPE = a.media_type =='tv' ? 'series' : 'movie'
                    return(
                        <div className="slide-box" key={i}
                            ...
                            <img src={a.backdrop_path == undefined ? `https://image.tmdb.org/t/p/original/djzzMW17bJxZXZz6STSkwbPzf2w.jpg` :
                                `${BASE_URL}${Array.isArray(props.data) ? props.data[i].backdrop_path : props.data.backdrop_path}`}
