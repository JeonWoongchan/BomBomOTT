        ...
        <Container>
          <Navbar.Brand className="header-buttons">
            <img
              ...
              src="/img/disney_Plus_logo.png"
              onClick={() => {
                navigate(`/main/${nowProfileCode}`);
              }}
            />
            ...
            <NavMenu
              icon="search"
              menu="검색"
              link={`/search/${nowProfileCode}`}
            />
            <NavMenu icon="add" menu="관심 콘텐츠" link="" />
            <NavMenu
              icon="movie"
              menu="영화"
              link={`/category/${nowProfileCode}/movie/recommend`}
            />
            <NavMenu
              icon="tv_gen"
              menu="시리즈"
              link={`/category/${nowProfileCode}/series/recommend`}
            />
            <NavMenu
              icon="forum"
              menu="커뮤니티"
              link={`/board/${nowProfileCode}`}
            />
          </Navbar.Brand>
          <Navbar.Toggle />
          <Navbar.Text>
